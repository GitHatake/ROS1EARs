...
"""autogenerated by genpy from torobo_msgs/MoveTeachingPointActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class MoveTeachingPointActionFeedback(genpy.Message):
  _md5sum = "2cc954be99e159662ddc989a8e109c42"
  _type = "torobo_msgs/MoveTeachingPointActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','torobo_msgs/MoveTeachingPointFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveTeachingPointActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = torobo_msgs.msg.MoveTeachingPointFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = torobo_msgs.msg.MoveTeachingPointFeedback()
