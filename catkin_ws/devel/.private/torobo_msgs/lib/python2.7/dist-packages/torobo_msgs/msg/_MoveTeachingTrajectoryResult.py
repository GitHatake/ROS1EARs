...
"""autogenerated by genpy from torobo_msgs/MoveTeachingTrajectoryResult.msg. Do not edit."""
import codecs
import sys
...
class MoveTeachingTrajectoryResult(genpy.Message):
  _md5sum = "5af78d1aaab840aeb31f007340c79c5c"
  _type = "torobo_msgs/MoveTeachingTrajectoryResult"
...
"""
  ...
  __slots__ = ['errorCode','jointState']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveTeachingTrajectoryResult, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_i3I().pack(_x.errorCode, _x.jointState.header.seq, _x.jointState.header.stamp.secs, _x.jointState.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.errorCode, _x.jointState.header.seq, _x.jointState.header.stamp.secs, _x.jointState.header.stamp.nsecs,) = _get_struct_i3I().unpack(str[start:end])
      start = end
      end += 4
