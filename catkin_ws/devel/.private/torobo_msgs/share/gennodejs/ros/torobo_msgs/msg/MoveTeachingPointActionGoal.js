...
let MoveTeachingPointGoal = require('./MoveTeachingPointGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class MoveTeachingPointActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new MoveTeachingPointGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MoveTeachingPointGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MoveTeachingPointActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = MoveTeachingPointGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += MoveTeachingPointGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveTeachingPointActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = MoveTeachingPointGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new MoveTeachingPointGoal()
    }
...
module.exports = MoveTeachingPointActionGoal;
