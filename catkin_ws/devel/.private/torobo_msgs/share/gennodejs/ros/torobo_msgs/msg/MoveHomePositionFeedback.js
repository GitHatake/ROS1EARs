...
class MoveHomePositionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MoveHomePositionFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveHomePositionFeedback(null);
...
module.exports = MoveHomePositionFeedback;
