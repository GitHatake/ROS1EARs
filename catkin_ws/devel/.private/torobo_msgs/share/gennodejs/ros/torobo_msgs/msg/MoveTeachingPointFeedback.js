...
class MoveTeachingPointFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MoveTeachingPointFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveTeachingPointFeedback(null);
...
module.exports = MoveTeachingPointFeedback;
