...
class MoveTeachingTrajectoryResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MoveTeachingTrajectoryResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveTeachingTrajectoryResult(null);
...
MoveTeachingTrajectoryResult.Constants = {
  SUCCESSFUL: 0,
  FAILURE: -1,
  PREEMPTED: -2,
}

module.exports = MoveTeachingTrajectoryResult;
