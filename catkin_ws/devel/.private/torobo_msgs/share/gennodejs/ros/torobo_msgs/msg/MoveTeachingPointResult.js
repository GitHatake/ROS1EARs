...
class MoveTeachingPointResult {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MoveTeachingPointResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveTeachingPointResult(null);
...
MoveTeachingPointResult.Constants = {
  SUCCESSFUL: 0,
  FAILURE: -1,
  PREEMPTED: -2,
}

module.exports = MoveTeachingPointResult;
