...
get_filename_component(_filename "/home/aokilablinuxws/catkin_ws/src/realsense-ros/ddynamic_reconfigure/test/TutorialParams.srv" NAME_WE)
add_custom_target(_ddynamic_reconfigure_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ddynamic_reconfigure" "/home/aokilablinuxws/catkin_ws/src/realsense-ros/ddynamic_reconfigure/test/TutorialParams.srv" ""
)
...
_generate_srv_cpp(ddynamic_reconfigure
  "/home/aokilablinuxws/catkin_ws/src/realsense-ros/ddynamic_reconfigure/test/TutorialParams.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ddynamic_reconfigure)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ddynamic_reconfigure\")")
  # install generated code
  install(
