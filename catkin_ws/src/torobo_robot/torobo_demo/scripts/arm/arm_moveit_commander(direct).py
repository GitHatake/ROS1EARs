...
def main():
    ...
    wp1 = create_pose(zero_pos, [ 0.0, 0.0, 0.0], 0.169, 0.00, -0.156, np.radians(0.1), np.radians(-85.4), np.radians(-0.1))
    wp2 = create_pose(zero_pos, [ 0.0, 0.0, 0.0], 0.761, 0.025, -0.633, np.radians(177.4), np.radians(26.9), np.radians(178.8))
    wp3 = create_pose(zero_pos, [ 0.0, 0.0, 0.0], 0.117, 0.031, -1.065, np.radians(179.3), np.radians(-29.0), np.radians(-176.3))
    wp4 = create_pose(zero_pos, [ 0.0, 0.0, 0.0], 0.667, 0.072, -0.689, np.radians(179.3), np.radians(20.4), np.radians(175.5))
    wp5 = create_pose(zero_pos, [ 0.0, 0.0, 0.0], 0.463, 0.072, -0.916, np.radians(177.7), np.radians(-4.7), np.radians(-177.1))
    #wp6 = create_pose(zero_pos, [np.radians(180), np.radians(30.0), np.radians(-180)], 0.117, 0.031, -1.065, 0.0, np.radians(0.0), 0.0)
