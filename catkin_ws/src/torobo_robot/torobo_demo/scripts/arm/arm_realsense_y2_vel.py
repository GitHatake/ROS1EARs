...
def main():
    ...
    try:
        ...
        for i in range(100):
            ...
            try:
                velocity_value1 = (second_ddata_probe - first_ddata_probe)*350

                if velocity_value1 >= 2:
                    velocity_value = 2
                else:
                    velocity_value = velocity_value1
            ...
            if second_ddata_probe > first_ddata_probe:
                torobo_easy_command.SendEasyCommandText(controller, "v 2 {}".format(velocity_value))
                torobo_easy_command.SendEasyCommandText(controller, "v 4 {}".format(velocity_value))
                torobo_easy_command.SendEasyCommandText(controller, "v 6 {}".format(-2*velocity_value))
                a += 1

                rospy.sleep(0.8)

            elif second_ddata_probe <= first_ddata_probe:
                if second_ddata_probe - second_ddata_surface > 0.002:
                    ...
                    rospy.sleep(0.8)
                elif second_ddata_probe - second_ddata_surface <= 0.002:
