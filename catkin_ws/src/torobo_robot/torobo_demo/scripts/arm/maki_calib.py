...
def main():
    ...
    wp2 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.6108, 0.1321, -0.771, np.radians(164.1), np.radians(8.3), np.radians(-160.3))
    wp3 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.5108, 0.1321, -0.771, np.radians(164.1), np.radians(8.3), np.radians(-160.3))
