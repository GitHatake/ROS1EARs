...
def main():
    ...
    wp1 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.529, 0.0, -0.775, np.radians(180), np.radians(15.0), np.radians(-180))
    wp2 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.529, 0.23, -0.775, np.radians(180), np.radians(15.0), np.radians(-180))
    wp3 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.529, -0.23, -0.775, np.radians(180), np.radians(15.0), np.radians(-180))
    #wp4 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.529, 0.0, -0.7, np.radians(180), np.radians(30.0), np.radians(-180))
    wp4 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.529, 0.23, -0.775, np.radians(180), np.radians(15.0), np.radians(-180))
    wp5 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.529, -0.23, -0.775, np.radians(180), np.radians(15.0), np.radians(-180))
    #wp7 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.529, 0.0, -0.7, np.radians(180), np.radians(30.0), np.radians(-180))
    wp6 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.529, 0.23, -0.775, np.radians(180), np.radians(15.0), np.radians(-180))
    wp7 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.529, -0.23, -0.775, np.radians(180), np.radians(15.0), np.radians(-180))
    #wp10 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.529, 0.0, -0.7, np.radians(180), np.radians(30.0), np.radians(-180))
    wp8 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.529, 0.23, -0.775, np.radians(180), np.radians(15.0), np.radians(-180))
    wp9 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.529, -0.23, -0.775, np.radians(180), np.radians(15.0), np.radians(-180))
    wp10 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.529, 0.0, -0.775, np.radians(180), np.radians(15.0), np.radians(-180))
