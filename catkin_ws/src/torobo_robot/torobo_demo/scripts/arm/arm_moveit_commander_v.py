...
def main():
    ...
    wp1 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.47, 0.0, -0.739, np.radians(180), np.radians(0.0), np.radians(-180))
    ...
    wp4 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.45, 0.0, -0.739, np.radians(180), np.radians(0.0), np.radians(-180))
    wp5 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.47, 0.0, -0.739, np.radians(180), np.radians(0.0), np.radians(-180))
    wp6 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.45, 0.0, -0.739, np.radians(180), np.radians(0.0), np.radians(-180))
    wp7 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.47, 0.0, -0.739, np.radians(180), np.radians(0.0), np.radians(-180))
    wp8 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.45, 0.0, -0.739, np.radians(180), np.radians(0.0), np.radians(-180))
    wp9 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.47, 0.0, -0.739, np.radians(180), np.radians(0.0), np.radians(-180))
    wp10 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.45, 0.0, -0.739, np.radians(180), np.radians(0.0), np.radians(-180))
