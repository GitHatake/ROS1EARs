...
def main():
    ...
    #with open('/home/aokilablinuxws/catkin_ws/src/torobo_robot/torobo_demo/scripts/arm/2021_kaiya_csv/test_manipulability_joint_7.csv','a') as f:
    ...
    while not rospy.is_shutdown():
        jac = np.matrix(arm.get_jacobian_matrix(joint_state))
        jac_trans = jac.T
