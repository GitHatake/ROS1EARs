...
def main():
    ...
    wp1 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.4731, 0.1522, -0.7273, np.radians(179.1), np.radians(-3.0), np.radians(-161.0))
    #[yaw]kara,[-]wokesita
    #wp1 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.5, 0.0, -0.7867, np.radians(0.0), np.radians(0.0), np.radians(0.0))
    #wp2 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.5908, 0.1321, -0.771, np.radians(164.1), np.radians(8.3), np.radians(160.3))
    #wp3 = create_pose(zero_pos, [0.0, 0.0, 0.0], 0.5308, 0.1321, -0.771, np.radians(164.1), np.radians(8.3), np.radians(160.3))
