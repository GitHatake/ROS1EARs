...
def main():
    with open("/home/aokilablinuxws/catkin_ws/src/torobo_robot/torobo_demo/scripts/arm/test/1222.csv") as csv_f:
...
class Torobo:
    ...
    def compute_fk(self, joint_angles):
        ...
        with open('/home/aokilablinuxws/catkin_ws/src/torobo_robot/torobo_demo/scripts/arm/test/2022_12_22.csv','a') as f:
            writer = csv.writer(f)
