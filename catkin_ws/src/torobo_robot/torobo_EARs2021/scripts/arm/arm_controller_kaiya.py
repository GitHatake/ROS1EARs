...
with open("/home/aokilablinuxws/kaiya_posdata/tatsushi_tannou_10Hz_pos_1.csv") as pos_data_f:
...
with open("/home/aokilablinuxws/kaiya_posdata/tatsushi_tannou_10Hz_vel_1.csv") as vel_data_f:
...
def main():
    rospy.init_node("toroboarm_arm_controller_kaiya_node", anonymous=True)
    ...
    for i in range(1, csv_line-1):
        ...
        while not rospy.is_shutdown():
            ...
            #send_data.RealsenseDepth = 0.20
            rospy.loginfo(via_data)
            if any(elem < (Hz/2.5-1) for elem in via_data):
                break
