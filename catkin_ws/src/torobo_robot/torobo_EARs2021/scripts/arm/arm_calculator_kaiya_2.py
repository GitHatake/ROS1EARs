...
def main():
    rospy.init_node("toroboarm_arm_calculator_kaiya_2_node", anonymous=True)
    ...
    global wait_callback, JointValue
    ...
    while not rospy.is_shutdown():
        ...
        """
        original_position = torobo.compute_fk(joint_angles = np.radians(JointValue))
        JointValue = np.degrees(torobo.compute_ik(x=original_position[0], y=original_position[1], z=original_position[2], roll=original_position[3], pitch=original_position[4], yaw=original_position[5]))
        """
