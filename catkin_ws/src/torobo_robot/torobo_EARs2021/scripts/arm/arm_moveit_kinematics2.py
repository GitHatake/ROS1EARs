...
def main():
    with open("/home/aokilablinuxws/catkin_ws/src/torobo_robot/torobo_demo/scripts/arm/test/test1028.csv") as csv_f:
...
class Torobo:
    ...
    def compute_fk(self, joint_angles):
        ...
        with open('/home/aokilablinuxws/catkin_ws/src/torobo_robot/torobo_demo/scripts/arm/test/test1028_fk.csv','a') as f:
            writer = csv.writer(f)
    ...
    def compute_ik(self, x, y, z, roll, pitch, yaw):
        ...
        """
        with open('/home/aokilablinuxws/catkin_ws/src/torobo_robot/torobo_demo/scripts/arm/2021_tatsushi_csv/kannshou_ik_kine.csv','a') as f:
            writer = csv.writer(f)
